        ...
        <FadeIn>
          <section className="mb-8 text-center">
            <motion.div
              ...
              className="inline-block p-4 bg-primary-container rounded-3xl mb-4"
            >
            ...
            <p className="text-on-surface-variant text-sm leading-relaxed">
              Görüşme öncesi, sonrası veya herhangi bir konuda
              özgürce yazabilirsiniz. Mesajlarınız gizli tutulur. Psikologunuz en kısa sürede dönüş yapacaktır.
            </p>
          </section>
        </FadeIn>
          ...
          <FadeInView>
            <div className="bg-surface-lowest rounded-3xl p-6 border border-outline-variant/10 shadow-[0_10px_40px_rgba(0,0,0,0.04)]">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                >
                  <span className="material-symbols-outlined text-base align-middle mr-1">visibility_off</span>
                  Anonim
                </motion.button>
                <motion.button
                  type="button"
          ...
          <FadeInView delay={0.05}>
            <div className="bg-surface-lowest rounded-3xl p-6 border border-outline-variant/10 shadow-[0_10px_40px_rgba(0,0,0,0.04)]">
              ...
              <p className="text-[11px] text-outline mt-2 ml-1">
                Cevap alabilmek için e-posta adresinizi girebilirsiniz.
              </p>
            </div>
          </FadeInView>
            ...
            <div className="bg-surface-lowest rounded-3xl p-6 border border-outline-variant/10 shadow-[0_10px_40px_rgba(0,0,0,0.04)]">
              ...
              <div className="space-y-2">
                {KATEGORILER.map((k) => (
                  ...
                  >
                    <span className={`material-symbols-outlined text-lg ${kategori === k.label ? "text-primary" : "text-on-surface-variant/50"}`}>
                      {k.icon}
                    </span>
                    {k.label}
                  </motion.button>
          ...
          <FadeInView delay={0.15}>
            <div className="bg-surface-lowest rounded-3xl p-6 border border-outline-variant/10 shadow-[0_10px_40px_rgba(0,0,0,0.04)]">
              ...
              <div className="flex justify-between mt-1 px-1">
                ...
                <span className={`text-[10px] transition-colors ${mesaj.length > 4500 ? "text-error font-bold" : "text-outline"}`}>
                  {mesaj.length}/5000
                </span>
              </div>
            </div>
